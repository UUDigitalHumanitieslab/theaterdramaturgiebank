					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<a href="http://dig.hum.uu.nl/" target="_blank">
								<img id="dhlab_image" class="aligncenter" alt="Digital Humanities Lab" src="https://theaterdramaturgiebank.sites.uu.nl/wp-content/uploads/sites/150/2016/10/dhlab.jpg">
							</a>
						</div>
						<div class="col-md-4 col-sm-6">
							<p class="source-org copyright pull-right">
								&copy; <?php echo date('Y'); ?> 
								<a href="http://dig.hum.uu.nl/" target="_blank">Digital Humanities Lab</a><br/>
								<?php _e('Utrecht University', 'uu2014'); ?>, 
								<a href="
									<?php 
